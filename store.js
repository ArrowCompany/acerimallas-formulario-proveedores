...
function mapMantenimiento(row) {
  return { id: row[0], equipoId: row[1], fecha: row[2], tipo: row[3], observacion: row[4], detalle: row[5], pdfUrl: row[6], origen: row[7], modoPago: row[8], costo: row[9], eliminado: row[10] === true };
}
